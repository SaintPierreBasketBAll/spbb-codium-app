<footer class="footer">
    <div class="footer-content">
      ...
      <div class="footer-section">
        ...
        <div class="social-links">
          <a href="https://www.facebook.com/profile.php?id=61565916243122" target="_blank" aria-label="Facebook">
    ...
    <img src="/images/logo.png" alt="SPBB Basketball Logo with flame design" class="footer-logo">
